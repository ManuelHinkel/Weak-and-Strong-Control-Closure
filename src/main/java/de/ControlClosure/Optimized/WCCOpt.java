...
//            if (scc.ThetaHat != null && scc.ThetaHat.size() >= 2) {
...
//                if (scc.ThetaHat != null && !scc.ThetaHat.isEmpty()) {
...
//                                sccInc.B.add(u);
//
//                                if (sccInc.ThetaHat == null) {
//                                    sccInc.ThetaHat = new HashSet<>();
//                                }
//                                sccInc.ThetaHat.addAll(scc.ThetaHat);
